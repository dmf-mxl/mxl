...
namespace
{
    ...
    private:
        ...
        struct Cursor
        {
            Cursor(mxlRational const& rate, std::uint32_t windowSize, std::int64_t readDelay)
                : _rate{rate}
            ...
            void realign(std::uint64_t timeNow)
            {
            ...
            [[nodiscard]]
            std::uint64_t currentIndex() const noexcept
            {
                return _currentIndex;
            }

            [[nodiscard]]
            std::uint64_t requestedIndex() const noexcept
            {
                return _requestedIndex;
            }

            [[nodiscard]]
            std::uint64_t deliveryDeadline() const noexcept
            {
        ...
        private:
            ...
            mxlRational const _rate;
            std::uint32_t const _windowSize;
            std::int64_t const _readDelayGrains;
