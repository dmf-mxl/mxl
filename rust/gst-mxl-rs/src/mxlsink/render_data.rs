...
use crate::format;
use crate::mxlsink::{self, state::DataState};
...
pub(crate) fn data(
    ...
    let data_state = state.data.as_ref().ok_or(gst::FlowError::Error)?;
